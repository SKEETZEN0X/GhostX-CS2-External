...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    ImU32 border_col = GetColorU32(ImVec4(1.0f, 0.84f, 0.0f, hovered ? 1.0f : 0.6f)); // doré
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    ImVec4 hoverCol = ImVec4(0.20f, 0.20f, 0.20f, 1.0f);  // hover foncé
    ImVec4 selectCol = ImVec4(1.0f, 0.84f, 0.0f, 0.25f);   // doré transparent
    ImVec4 borderCol = ImVec4(1.0f, 0.84f, 0.0f, 0.9f);    // bordure dorée
    ImVec4 textCol = ImVec4(0.95f, 0.95f, 0.95f, 1.0f);  // texte blanc
    ImVec4 textColSel = ImVec4(1.0f, 0.9f, 0.5f, 1.0f);     // texte doré clair si sélectionné
    ...
    // Bordure fine dorée si sélectionné
    if (selected)
